...
<div class="mx-auto max-w-3xl px-4 py-16 pt-24 sm:px-6">
    ...
    <div class="sur-card mb-8 border-white/10">
        <h2 class="mb-4 text-lg font-semibold text-cyan-300">Our Mission</h2>
    ...
    <div class="sur-card mb-8 border-white/10">
        <h2 class="mb-4 text-lg font-semibold text-cyan-300">How It Works</h2>
        <p class="leading-relaxed text-zinc-300">
    ...
    <div class="sur-card mb-10 border-white/10">
        <h2 class="mb-4 text-lg font-semibold text-cyan-300">Why Choose Us</h2>
