...
- **Cookie consent:** first-party banner (Bootstrap modal) stores analytics preference in the browser and loads Matomo only after opt-in. Footer link reopens settings. Cookiebot dependency removed.
